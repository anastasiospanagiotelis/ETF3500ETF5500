...
--
  ...
  + Customer A: Trippie Redd, Blackbear, Lil Peep, XXXTentacion
  + Customer B: Trippie Redd, Lil Peep, Juice Wrld
  + Customer C: XXXTentacion, Ski Mask, YungBlud<!--D-->
--
...
--
  ...
  + $A\cap B = \left\{\mbox{Trippie Redd, Lil Peep}\right\}$ 
  + $|A\cap B|=2$
  + $\begin{align}A\cup B =& \{\mbox{Trippie Redd, Lil Peep,}\\& \mbox{Blackbear, XXXTentacion, Juice Wrld}\}\end{align}$ 
  + $|A\cup B|=5$<!--D-->
--
