...
- The data seem to suggest that each of the variables can be
explained by just two or three factors.
--

- When we do PCA sometimes it is easy to interpret the PCs.
--

- Sometimes the PCs are hard to interpret.
--
...
- Many packages in R do factor analysis, we use `factanal` from the `stats` package
...
- This can be achieved using the `tidy` function in the `broom` package.
...
- Factor 2 takes everything into account except pupil-teacher ratio, crime and race.
